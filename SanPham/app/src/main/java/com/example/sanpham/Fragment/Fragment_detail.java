...
import com.example.lib.Model.photo;
...
public class Fragment_detail extends Fragment {
    ...
    private void anhXa() {
        ...
        product.setOutPrice("90000");
        listProduct.add(product);
        ProductAdapterRecyclerview productAdapter = new ProductAdapterRecyclerview(view.getContext(), R.layout.san_pham, listProduct);
